...
export default function GameSquare(props: Props) {
  ...
  return (
    <div
      className={cn(
        "bg-primary-200 ring-primary-300 text-primary-900 hover:bg-primary-300 hover:ring-primary-400 col-span-4 flex h-24 cursor-pointer flex-col items-center justify-center rounded bg-gradient-to-br text-center ring-2",
        isGuessed &&
